        ...
        <div class="flexContainers">
            ...
            <div class="left">
                ...
                if (isset($_POST['timeIn'])) {
                    ...
                    $sqlCheck = "SELECT timeIn, timeOut, dateToday FROM hr_dtr WHERE idNumber = $idNumber ORDER BY timeIn DESC LIMIT 1";
                    ...
                    if ($queryCheck && $queryCheck->num_rows > 0) {
                        ...
                        $dateToday = $result['dateToday'];
                        $curDate = time();
                        $curDateFormatted = date("Y-m-d", $curDate);

                        // a condition if the user has a time out in his/her latest data  
                        if ($timeIn && !$timeOut && $dateToday == $curDateFormatted) {
                            echo '
