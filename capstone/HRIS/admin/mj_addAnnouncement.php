...
<body>
                    ...
                    if ($query && $query->num_rows > 0) {
                        while ($row = $query->fetch_assoc()) {
                            ...
                            echo "
                                ...
                                <td td class='align-middle'><i class='fa-solid fa-pen-to-square' id='button'></i></td>
                                <tr>
    ...
    if (isset($_POST['apply'])) {
        ...
        $sql = "INSERT INTO hr_annoucement (scheduledDate, scheduledTime, purpose, venue, type) VALUES ('$scheduledDate', '$scheduledTime', '$purpose', '$venue', '$type')";

        $updateQuery = $connectionString->query($sql);
    ...
    <input type="date" name="scheduledDate" id="" form="announcement" class="inputs">
    <input type="text" name="scheduledTime" id="time" form="announcement" class="inputs" placeholder="Scheduled Time">
    <input type="text" name="purpose" id="" form="announcement"  class="inputs purpose" placeholder="Purpose">
    <input type="text" name="venue" id="" form="announcement" class="inputs" placeholder="Venue">
